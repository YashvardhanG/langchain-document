...
def main():
    ...
    if user_question and final_db:
        ...
        llm = HuggingFacePipeline.from_model_id(model_id="HuggingFaceH4/zephyr-7b-beta", task="text2text-generation", model_kwargs={"temperature": 0.7, "max_new_tokens": 512, "top_p": 0.95, "top_k" :50})
