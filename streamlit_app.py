...
def main():
    ...
    if user_question and final_db:
        ...
        llm = HuggingFacePipeline.from_model_id(model_id="google/flan-ul2", task="text2text-generation", model_kwargs={"temperature": 0.7, "max_length": 512, "top_p":0.95, "repetition_penalty":1.1})
